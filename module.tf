module "AppServicePlan" {
  ...
  for_each = try(var.appServiceTemplate.appServicePlan, {})
...
module "appServiceLinux" {
  source   = "github.com/canada-ca-terraform-modules/terraform-azurerm-caf-app_service_linux.git?ref=v1.2.0"
